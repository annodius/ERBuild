...
@Deprecated
public final class StartSidebarPresenter implements SidebarPresenter {

    private static final String CHILD_MAPPING = GarantUrl.GARANT_RESULT;

    private SidebarChaneNodeDto firstUiChaneNode;

    @PostConstruct
    private void init() {
        final var PARENT_NAME = "ИНФОРМАЦИЯ";
